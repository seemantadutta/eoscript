...
# This is the file that should be used in places like Paradise Canyon, TX
# With totality of around 3mins.
...
if __name__ == '__main__':
    ...
    def gen_main_solar_eclispe_script():
        ...
        # C2->MAX cycle
        _main_sequence("C2 Back up sequence 1 (C2->MAX)", "C2", 4.0, 1, 1/15, 2, "increasing", 400, 4)
        _insert_newlines(3)

        # o = script.offset + 1.0
        # _main_sequence("C2 Back up sequence 2 (C2->MAX)", "C2", o, 1, 1/30, 1/4000, "decreasing", 400, 4)
        # _insert_newlines(3)
        ...
        o = script.offset + 1.0
        _main_sequence("C3 Back up sequence 2 (MAX->C3)", "MAX", o, 1, 1/30, 1/4000, "decreasing", 400, 4)
        _insert_newlines(3)
        ...
        script.save("Eclipse2024CanonMain6DV2_modded_3min.csv")
    ...
    def add_partial_progress_shots():
        ...
        script.iso = 100
        script.fstop = 8
        f = open("Eclipse2024CanonMain6DV2_modded_3min.csv", mode="a")
