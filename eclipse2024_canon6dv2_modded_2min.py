...
if __name__ == '__main__':
    ...
    def gen_main_solar_eclispe_script():
        ...
        _main_sequence("MAX Main sequence (MAX->C3)", "MAX", offset, 2, 4, 4, "decreasing", 100, 2)
        _insert_newlines(3)
        ...
        script.save("Eclipse2024CanonMain6DV2_modded_2min.csv")
    ...
    def add_partial_progress_shots():
        ...
        script.iso = 100
        script.fstop = 8
        f = open("Eclipse2024CanonMain6DV2_modded_2min.csv", mode="a")
